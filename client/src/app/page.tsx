    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-300 rounded-full opacity-20"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Lingo是一个强大的AI内容生成平台，帮助你轻松创建文本、图像和视频内容
            </p>
            ...
            >
              <Card className="border-0 shadow-lg h-full">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50">
                  ...
                  <CardDescription>AI辅助创作，快速生成高质量文本内容</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            >
              <Card className="border-0 shadow-lg h-full">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50">
                  ...
                  <CardDescription>AI驱动的图像创作，将创意变为现实</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start">
            ...
            >
              <Card className="border-0 shadow-lg h-full">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50">
                  ...
                  <CardDescription>AI视频创作，让你的故事动起来</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">准备好开始创作了吗？</h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              加入Lingo，释放你的创意潜力，让AI成为你的创作伙伴
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
